...
const mockApplications = [
  {
    ...
    phone: '0901 234 567',
    address: 'Đà Nẵng',
    introduce: 'Có 3 năm kinh nghiệm dọn dẹp và nấu ăn.',
    certifications: 'Chứng chỉ vệ sinh công nghiệp',
    submitted_at: '2025-09-05 10:00:00',
    status: 'pending',
  },
  {
    id: 2,
    ...
    phone: '0902 111 222',
    address: 'Hà Nội',
    introduce: 'Kinh nghiệm chăm sóc người già 2 năm.',
    certifications: '',
    submitted_at: '2025-09-06 09:30:00',
    status: 'pending',
  },
];

const TaskerApprovals = () => {
            ...
            <tbody>
              {shown.map((a) => (
                <tr key={a.id}>
                  ...
                  <td>
                    <span className={`badge badge-${a.status === 'pending' ? 'warning' : a.status === 'approved' ? 'success' : 'danger'}`}>
                      {a.status}
                    </span>
                  </td>
                  <td>
...
export default TaskerApprovals;
